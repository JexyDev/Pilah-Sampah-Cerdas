          ...
          <div className="mt-6 pt-6 border-t border-outline-variant/30">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[12px] font-bold text-on-surface">
                {Math.floor(data.uptimeSeconds)} s
              </span>
            </div>
          </div>
        </div>
            ...
            >
              {[...Array(12)].map((_, i) => (
                <rect
                  key={i}
                  x={5 + i * 8}
                  y={20 - (data.peakLatency / 15) * Math.random()}
                  width="6"
                  height={20 + (data.peakLatency / 15) * Math.random()}
                  fill="#3b82f6"
                  rx="1"
                />
              ))}
        ...
        <div className="md:col-span-12 bg-white rounded-2xl shadow-sm border border-outline-variant/50 p-6 flex flex-col mt-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider mt-1">
                Daily Hits vs Misses (Last 14 Days)
              </p>
            </div>
