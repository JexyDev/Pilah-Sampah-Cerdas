...
const Monitoring: React.FC = () => {
  ...
  const mapCenter: [number, number] = useMemo(() => {
    ...
    return [-6.8903, 107.611]; // Default: Kecamatan Coblong, Bandung
  }, [bins]);
  ...
  return (
    <div className={styles.monitoringContainer}>
      ...
      <div className={styles.mapWrapper}>
        <MapContainer center={mapCenter} zoom={15} scrollWheelZoom={true} className={styles.map}>
          <TileLayer
                ...
                >
                  <Popup>
                    <div className={styles.popupContent}>
                      <strong>Tong {bin.category.name}</strong>
                      <br />
                      Kapasitas Terisi: {percentage.toFixed(1)}% ({vol}L / {max}L)
                      <br />
