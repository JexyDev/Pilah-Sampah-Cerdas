 ...
 */
router.post("/detect-mock", authMiddleware, roleMiddleware(["WARGA"]), // REKAP-01 FIX: Only WARGA can submit waste for detection
aiController.detect);
router.post("/upload", authMiddleware, roleMiddleware(["WARGA"]), uploadAvatarMiddleware.single("image"), aiController.uploadWastePhoto);
/**
 * @swagger
 * /api/v1/waste/detect:
 *   post:
