...
export class AuthController {
    ...
    async updateProfile(req, res) {
        try {
            ...
            const updatedUser = await authService.updateProfile(req.user.userId, name, email, phone ?? undefined, address ?? undefined, fotoProfil ?? undefined);
            res.status(200).json({
    ...
    async uploadAvatar(req, res) {
        try {
            ...
            await authService.updateProfile(req.user.userId, undefined, undefined, undefined, undefined, filePath);
            res.status(200).json({
                success: true,
