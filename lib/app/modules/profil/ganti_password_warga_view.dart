...
class GantiPasswordWargaView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GantiPasswordWargaView> createState() =>
      _GantiPasswordWargaViewState();
}

class _GantiPasswordWargaViewState
    extends ConsumerState<GantiPasswordWargaView> {
  ...
  Future<void> _submitGantiPassword() async {
    ...
    if (!hasMinLength ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Kata sandi baru tidak memenuhi syarat keamanan! Pastikan semua indikator berwarna hijau.',
          ),
