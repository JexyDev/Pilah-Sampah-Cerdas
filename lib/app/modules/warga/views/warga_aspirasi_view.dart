...
class _WargaAspirasiViewState extends ConsumerState<WargaAspirasiView> {
  ...
  final List<String> _kategoriAspirasiList = [
    'UMUM',
    'FASILITAS',
    'PELAYANAN',
    'LAINNYA',
  ...
  Future<void> _onSubmit() async {
    ...
    if (_fotoBukti == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Foto bukti fisik dari galeri wajib dilampirkan.'),
          backgroundColor: AppColors.dangerRed,
        ),
      );
      return;
    ...
    if (mounted) {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(errorMsg ?? 'Gagal mengirim aspirasi.'),
            backgroundColor: AppColors.dangerRed,
          ),
        );
      }
                    ...
                    child: _fotoBukti != null
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Ketuk untuk unggah foto dari galeri',
                                style: TextStyle(
