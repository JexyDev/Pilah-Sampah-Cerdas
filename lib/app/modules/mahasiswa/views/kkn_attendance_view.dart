          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                _buildInfoRow('Target Lokasi:', state.activeActivity != null ? (state.activeActivity!['address'] ?? state.activeActivity!['targetLokasi'] ?? state.activeActivity!['location'] ?? '-') : '-'),
                const SizedBox(height: 8),
                _buildInfoRow('Radius Toleransi:', state.activeActivity != null ? '${state.activeActivity!['radius'] ?? state.activeActivity!['radiusMeter'] ?? 100} Meter' : '-'),
                const SizedBox(height: 8),
                _buildInfoRow('Jam Kegiatan:', state.activeActivity != null ? (state.activeActivity!['jamKegiatan'] ?? state.activeActivity!['time'] ?? '08:00 - 16:00') : '-'),
                const SizedBox(height: 8),
                _buildInfoRow('Nama Kegiatan:', state.activeActivity != null ? (state.activeActivity!['namaKegiatan'] ?? state.activeActivity!['zoneName'] ?? state.activeActivity!['title'] ?? '-') : '-'),
              ],
            ),
          ),
        ),
