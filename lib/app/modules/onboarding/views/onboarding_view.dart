  ...
  Widget _buildMockContainer(Widget child) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final double containerWidth = constraints.maxWidth > 250
            ? 250
    ...
    if (role == UserRole.mahasiswaKkn) {
      return [
        OnboardingSlide(
          ...
          description:
              'Tugas Anda adalah memberdayakan warga. Buka Dasbor KKN, cari target warga binaan yang belum diaktivasi, dan datangi rumah mereka.',
          mockupWidget: _buildMahasiswaDaftarMock(),
        ),
        OnboardingSlide(
          title: 'Aktivasi & Edukasi',
          description:
              'Pilih nama warga, lalu lakukan pemindaian kode QR pada tempat sampah mereka untuk melakukan aktivasi ke akun Warga.',
          mockupWidget: _buildWargaScanMock(),
        ),
        OnboardingSlide(
          title: 'Presensi & Laporan Praktis',
          description:
              'Sistem akan mendeteksi koordinat GPS Anda. Lakukan presensi di lokasi Posko dan kirim laporan ke DPL.',
      ...
      return [
        OnboardingSlide(
          ...
          description:
              'Sistem menilai kinerja Anda secara otomatis dari ketepatan waktu pengangkutan dan akurasi data. Tingkatkan skor Anda untuk insentif maksimal!',
          mockupWidget: _buildPetugasTungguMock(),
        ),
        OnboardingSlide(
          title: 'Cek Titik Kumpul Harian',
          description:
              'Buka Dasbor untuk melihat daftar titik kumpul tempat sampah pemilahan di wilayah penugasan (RT/RW) yang harus ditangani hari ini.',
          mockupWidget: _buildPetugasTitikMock(),
        ),
        OnboardingSlide(
          title: 'Timbang & Dapatkan Poin',
          description:
              'Datangi titik kumpul tersebut, timbang fisik sampah pemilahannya (kg), lalu ambil foto bukti. Kirim data dan dapatkan poin insentif!',
      ...
      return [
        OnboardingSlide(
          ...
          description:
              'Langkah kecil Anda berdampak besar. Mulai pisahkan sampah organik dan anorganik dari rumah Anda sekarang.',
          mockupWidget: _buildWargaHomeMock(),
        ),
        OnboardingSlide(
          title: 'Pindai Menggunakan AI',
          description:
              'Buka aplikasi, tekan fitur Pindai AI, lalu ambil foto sampah Anda. Sistem akan mengenalinya secara otomatis.',
          mockupWidget: _buildWargaScanMock(),
        ),
        OnboardingSlide(
          title: 'Kumpulkan Poin & Dapatkan Imbalan!',
          description:
              'Setiap sampah yang terpilah dengan benar bernilai poin. Dapatkan imbalan menarik dan tingkatkan kebersihan lingkungan Anda!',
