...
class MonitoringWargaScreen extends ConsumerStatefulWidget {
  const MonitoringWargaScreen({super.key});

  @override
  ConsumerState<MonitoringWargaScreen> createState() => _MonitoringWargaScreenState();
}

class _MonitoringWargaScreenState extends ConsumerState<MonitoringWargaScreen> {
