...
const PageLoadingFallback: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] w-full gap-3 py-16 animate-fade-in">
      ...
      <span className="text-xs font-semibold text-slate-400">{loadingText}</span>
    </div>
  );
};
  ...
  return (
    <>
      ...
      >
        ...
        <Route path="/gis" element={<Navigate to="/dasbor?tab=gis" replace />} />
        <Route path="/gis-eksekutif" element={<Navigate to="/dasbor?tab=gis" replace />} />
        <Route path="/gis-tata-kelola-sampah" element={<Navigate to="/dasbor?tab=gis" replace />} />
        ...
        <Route
          path="/monitoring"
          element={
            <ProtectedRoute resource="monitoring_sampah" allowedRoles={["SUPER_USER", "ADMIN_DLH", "CAMAT", "LURAH", "RW", "PETUGAS_RESIDU", "PIMPINAN", "PANITIA_TASKFORCE", "DPL", "DOSEN_PEMBIMBING", "MPL", "MAHASISWA_KKN", "WARGA", "DEVELOPER"]}>
              <Monitoring />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "DEVELOPER", "ADMIN_DLH", "CAMAT", "LURAH", "RW", "PIMPINAN", "PANITIA_TASKFORCE", "DPL", "DOSEN_PEMBIMBING"]}>
              <MonitoringAbsen />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["DEVELOPER", "DPL", "DOSEN_PEMBIMBING", "MPL", "SUPER_USER", "PANITIA_TASKFORCE", "PIMPINAN"]}>
              <LaporanPresensiPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["LURAH", "CAMAT", "SUPER_USER", "ADMIN_DLH", "PIMPINAN", "PANITIA_TASKFORCE", "DEVELOPER", "RW", "PETUGAS_RESIDU", "MAHASISWA_KKN", "DPL"]}>
        ...
        <Route
          path="/master-wilayah"
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "PIMPINAN", "PANITIA_TASKFORCE"]}>
              <MasterWilayah />
            </ProtectedRoute>
          }
        />
        ...
        <Route path="/monitoring-pengelolaan/tempat-sampah-teraktivasi" element={<Navigate to="/monitoring-pengelolaan/tempat-sampah?tab=teraktivasi" replace />} />
        <Route path="/tempat-sampah-teraktivasi" element={<Navigate to="/monitoring-pengelolaan/tempat-sampah?tab=teraktivasi" replace />} />
        <Route
          path="/peraturan"
          element={
            <ProtectedRoute
        ...
        <Route
          path="/dashboard-kkn"
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "DEVELOPER", "ADMIN_DLH", "DPL", "DOSEN_PEMBIMBING", "MPL", "MAHASISWA_KKN", "PIMPINAN", "PANITIA_TASKFORCE"]}>
              <KknDashboard />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "DEVELOPER", "ADMIN_DLH", "PIMPINAN", "PANITIA_TASKFORCE", "DPL", "DOSEN_PEMBIMBING", "MPL", "MAHASISWA_KKN"]}>
              <ProgramKerjaKkn />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["DEVELOPER", "DPL", "DOSEN_PEMBIMBING", "SUPER_USER", "PANITIA_TASKFORCE", "PIMPINAN"]}>
              <PenilaianProkerPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/dpl/logbook"
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "DPL", "DOSEN_PEMBIMBING", "MPL", "PIMPINAN", "PANITIA_TASKFORCE", "DEVELOPER", "MAHASISWA_KKN", "LURAH", "CAMAT", "RW"]}>
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "DPL", "DOSEN_PEMBIMBING", "MPL", "PIMPINAN", "PANITIA_TASKFORCE", "DEVELOPER", "LURAH", "CAMAT", "RW"]}>
              <LogAktivitasDpl />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/posko-kkn"
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "CAMAT", "LURAH", "RW", "PIMPINAN", "PANITIA_TASKFORCE", "DEVELOPER", "DPL", "DOSEN_PEMBIMBING", "MPL", "MAHASISWA_KKN", "WARGA"]}>
              <PoskoKknPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "CAMAT", "LURAH", "RW", "PETUGAS_RESIDU", "PANITIA_TASKFORCE", "PIMPINAN", "DPL", "DOSEN_PEMBIMBING", "MAHASISWA_KKN", "WARGA", "DEVELOPER"]}>
              <SetorSampah />
            </ProtectedRoute>
          }
        />
        ...
        <Route path="/pemilahan" element={<Navigate to="/monitoring-pemilahan/penyetoran-sampah" replace />} />
        <Route path="/monitoring-pemilahan" element={<Navigate to="/monitoring-pemilahan/penyetoran-sampah" replace />} />
        <Route
          path="/kkn-portal"
          element={
            <ProtectedRoute allowedRoles={["SUPER_USER", "ADMIN_DLH", "DPL", "DOSEN_PEMBIMBING", "MAHASISWA_KKN", "PIMPINAN", "PANITIA_TASKFORCE"]}>
              <KknDashboard />
            </ProtectedRoute>
          }
        />
