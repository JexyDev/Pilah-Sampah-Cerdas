      ...
      items: [
        {
          ...
          children: [
            { to: "/log-aktivitas", label: "Monitoring Log Aktivitas", allowed: ["DEVELOPER", "SUPER_USER"] as UserRole[] },
