...
export const TIMELINE_KKN_DATA: TimelineKknItem[] = [
  ...
  },
  {
    ...
    fase: "Fase 3 - Implementasi & Pembimbingan",
    kegiatanUtama: "Perluasan program ke seluruh RW; Aktivasi gamifikasi & leaderboard partisipasi warga; Pembimbingan pembentukan/penguatan bank sampah per RW",
  ...
  },
  {
    ...
    fase: "Fase 3 - Implementasi & Pembimbingan",
    kegiatanUtama: "Pembimbingan Pengangkutan sampah berbasis data (rute & jadwal via IoT/GPS); Pembimbingan pengolahan organik: kompos, biopori, budidaya maggot BSF",
