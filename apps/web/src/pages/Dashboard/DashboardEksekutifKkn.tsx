                    ...
                    >
                      ...
                      <td className="py-2.5 px-3 text-right">
                        <span
                          ...
                          title={`Poin DPL = (Poin Logbook × 60%) + (Poin Kelompok × 40%) = (${d.logbookCount ?? (d.poinLogbook ? Math.round(d.poinLogbook / 5) : 0)} log × 5 = ${d.poinLogbook ?? 0} × 60%) + (${d.poinKelompok ?? 0} × 40%) = ${d.points}`}
                        >
                          {d.points} Poin
                        </span>
                      </td>
