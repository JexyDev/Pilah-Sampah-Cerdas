            ...
            <table className="w-full text-left text-xs text-slate-700 dark:text-slate-300 border-collapse">
              <thead>
                <tr className="bg-slate-50/90 text-slate-500 border-b border-slate-200 dark:border-slate-800 text-[10.5px] uppercase tracking-wider font-bold">
                  ...
                  <th className="py-3.5 px-3 text-center font-black text-slate-900 dark:text-slate-100">Nilai Akhir</th>
                ...
                {paginatedStudents.map((st, idx) => {
                  ...
                  return (
                    <tr key={st.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3 px-3 text-center font-black text-sm text-slate-900 dark:text-slate-100">
