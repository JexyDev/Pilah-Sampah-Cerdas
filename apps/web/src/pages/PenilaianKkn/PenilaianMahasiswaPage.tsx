                ...
                {paginatedStudents.map((st, idx) => {
                  ...
                  return (
                    <tr key={st.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="font-bold text-slate-800">{st.kelompokName}</div>
                      ...
                      <td className="py-3.5 px-4 text-center">
                        <input
                          ...
                          className="w-20 px-2 py-1.5 text-center font-black text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500"
                        />
                      </td>
                      <td className="py-3.5 px-4">
                        <input
                          ...
                          className="w-full px-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500"
                        />
                      </td>
                      <td className="py-3.5 px-4 text-center">
                        <button
