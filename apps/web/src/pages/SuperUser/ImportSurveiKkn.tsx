              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                  {paginatedData.map((row, idx) => (
                    <tr key={idx} className="hover:bg-gray-50/50 dark:bg-slate-800/50 dark:hover:bg-slate-800/50 transition-colors">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                    {sheetSummaries.map((sheet) => (
                      <tr key={sheet.name} className="hover:bg-gray-50/50 dark:bg-slate-800/50 dark:hover:bg-slate-800/50 transition-colors">
          ...
          {loadingHistory ? (
            ...
            <div className="space-y-3">
              {history.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl border border-gray-100 dark:border-slate-800 bg-gray-50/30 dark:bg-slate-800/30 hover:bg-gray-50/60 dark:bg-slate-800/60 dark:hover:bg-slate-800/60 transition-colors"
                >
