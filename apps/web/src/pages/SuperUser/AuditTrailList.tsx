        ...
        <form onSubmit={handleSearchSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value="APPROVE_ACTIVATION">Approve Tempat Sampah</option>
              <option value="REJECT_ACTIVATION">Reject Tempat Sampah</option>
              <option value="REPORT_BIN_BROKEN">Lapor Tempat Sampah Rusak</option>
