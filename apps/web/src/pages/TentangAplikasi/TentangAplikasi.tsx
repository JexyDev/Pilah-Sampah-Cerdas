        ...
        <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">2. Presensi &amp; Validasi Ketidakhadiran</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                      Pada Tab <strong>Presensi &amp; Validasi Ketidakhadiran</strong>, periksa surat keterangan dokter/bukti izin mahasiswa. Anda dapat menyetujui, menolak, atau mengeskalasi permohonan izin lebih dari 3 hari ke Panitia Taskforce.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">1. Persetujuan Tempat Sampah Ber-QR</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">2. Pemantauan Partisipasi Warga</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">3. Fasilitas Kompos &amp; Rumah Maggot</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">4. Validasi Ide Inovasi Daur Ulang</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">1. Jadwal Pengangkutan Harian</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">1. Monitoring Spasial &amp; Peta Wilayah</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">2. Evaluasi Indeks Kepatuhan Wilayah</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-extrabold text-base text-slate-900 dark:text-slate-100">2. Eskalasi Izin Mahasiswa</h3>
                    </div>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <div className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2.5">
                    <span className="w-7 h-7 rounded-full bg-[#009966] text-white text-xs font-black flex items-center justify-center">1</span>
                    <h4 className="font-black text-sm text-slate-900 dark:text-slate-100">Pilah di Rumah Tangga</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2.5">
                    ...
                    <h4 className="font-black text-sm text-slate-900 dark:text-slate-100">Foto &amp; Scan QR Code</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2.5">
                    ...
                    <h4 className="font-black text-sm text-slate-900 dark:text-slate-100">Pengangkutan &amp; Poin</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          {userTab === "FAQ" && (
            <div className="space-y-4 animate-fade-in">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/90 shadow-xs space-y-4">
                <h3 className="font-black text-lg text-slate-900 dark:text-slate-100 flex items-center gap-2">
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-1">
                    <h4 className="font-bold text-xs text-slate-900 dark:text-slate-100">Q: Bagaimana jika tempat sampah warga belum terpasang stiker QR Code?</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400">A: Mahasiswa KKN bersama pengurus RW akan membagikan stiker QR Code resmi dan membantu proses aktivasi awal di lokasi rumah warga.</p>
                  </div>

                  <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-1">
                    <h4 className="font-bold text-xs text-slate-900 dark:text-slate-100">Q: Apa yang harus dilakukan jika tempat sampah sudah penuh sebelum jadwal angkut?</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400">A: Warga dapat mengunggah foto tempat sampah penuh di aplikasi mobile untuk mengirimkan notifikasi prioritas penjemputan ke petugas residu terdekat.</p>
                  </div>
          ...
          {techTab === "EXECUTIVE" && (
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs flex items-center gap-4 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">2 Kelas Output</h3>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs flex items-center gap-4 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">Tabungan Poin</h3>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs flex items-center gap-4 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">5 Tingkatan</h3>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs flex items-center gap-4 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-black text-slate-800 dark:text-slate-100">Real-Time Telemetri</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3">
                  ...
                  <h3 className="text-base font-black text-slate-800 dark:text-slate-100">1. Smart Waste Classification (AI Engine)</h3>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3">
                  ...
                  <h3 className="text-base font-black text-slate-800 dark:text-slate-100">2. Gamifikasi &amp; Sistem Poin Warga</h3>
                  <p className="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3">
                  ...
                  <h3 className="text-base font-black text-slate-800 dark:text-slate-100">3. Pemetaan Wilayah Terintegrasi</h3>
                  <p className="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3">
                  ...
                  <h3 className="text-base font-black text-slate-800 dark:text-slate-100">4. Role-Based Access Control (RBAC)</h3>
                  <p className="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  return (
                    <div key={idx} className="bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-2.5 hover:shadow-md transition-shadow">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl bg-emerald-50 text-[#009966] flex items-center justify-center font-bold">
                          <ItemIcon size={18} />
                        </div>
                        <h4 className="font-extrabold text-sm text-slate-800 dark:text-slate-100">{item.role}</h4>
                      </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-slate-50 dark:bg-slate-800/60 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2">
                    ...
                    <p className="text-lg font-black text-slate-800 dark:text-slate-100">640 x 640 RGB</p>
