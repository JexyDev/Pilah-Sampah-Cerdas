          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-xl overflow-hidden">
            <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full hover:bg-slate-200 flex justify-center items-center text-slate-500"
              >
                ✕
              </button>
            </div>
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="text-xs font-bold text-slate-600 uppercase flex gap-1 items-center">
              ...
              <div>
                <label className="text-xs font-bold text-slate-600 uppercase">Nomor HP</label>
                <input
                  type="text"
                  className="w-full mt-1 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
              ...
              <div>
                <label className="text-xs font-bold text-slate-600 uppercase flex gap-1 items-center">
                  <MapPin className="w-3 h-3" /> Zona Tugas (RT/RW)
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 transition-colors disabled:opacity-70"
                >
