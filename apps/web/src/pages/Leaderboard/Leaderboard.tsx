...
const Leaderboard: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-[1400px] mx-auto animate-fade-in">
      ...
      <div className="bg-white dark:bg-slate-900 p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3 sm:space-y-4">
        {/* System Toggle */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800 pb-3">
          <div className="grid grid-cols-2 sm:flex sm:items-center gap-2 w-full sm:w-auto">
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded-xl font-black text-xs transition-all cursor-pointer flex items-center justify-center gap-1.5 sm:gap-2 ${
                system === "system1"
          ...
          {system === "system1" && !["kelurahan", "overview"].includes(s1Tab) && (
            <div className="flex items-center bg-slate-100/80 dark:bg-slate-800/80 p-1 rounded-xl border border-slate-200/60 dark:border-slate-800/60 dark:border-slate-700 self-start sm:self-auto">
              <button
