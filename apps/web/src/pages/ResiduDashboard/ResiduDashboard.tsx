        ...
        <div className="pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex flex-wrap items-center gap-2.5 ml-auto sm:ml-0">
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer active:scale-95"
            >
              <CheckCircle className="w-3.5 h-3.5" />
              <span>Validasi Berat Aktual</span>
            </button>
            <button
              onClick={() => setShowViolationModal(true)}
              className="bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer active:scale-95"
            >
              <Camera className="w-3.5 h-3.5" />
              <span>Input Ketidakpatuhan</span>
            </button>
          </div>
        </div>
      </div>
