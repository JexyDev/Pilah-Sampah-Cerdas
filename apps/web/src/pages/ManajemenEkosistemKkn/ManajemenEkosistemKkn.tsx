      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-1">
            Pengelolaan kelompok mahasiswa KKN, alokasi wilayah dampingan, dan struktur dosen pembimbing lapangan.
          </p>
        </div>
      </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-100 dark:border-slate-800">
                        ...
                        <th className="p-4 font-bold text-xs text-slate-600 dark:text-slate-400 uppercase tracking-wider">Dosen Pembimbing (DPL)</th>
