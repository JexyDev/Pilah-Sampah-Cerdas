    ...
    <div className="flex h-[calc(100vh-64px)] overflow-hidden -m-6 bg-slate-50 font-sans">
      ...
      <div className="flex-1 relative flex flex-col bg-slate-100 border-r border-slate-200">
        ...
        <div className="w-full h-full relative z-0">
          ...
          {/* Map Legend Overlay for Manajemen Lokasi */}
            ...
            <div className="bg-white/95 backdrop-blur-md p-3 rounded-2xl border border-slate-200/90 shadow-xl">
              <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-2">
                <span className="font-black text-[11px] uppercase tracking-wider text-slate-800 flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Legenda Manajemen Lokasi
                </span>
              </div>
