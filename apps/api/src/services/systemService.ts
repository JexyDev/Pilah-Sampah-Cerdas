...
export const systemService = {
  ...
  getDefaultLandingContent: () => ({
    heroSlides: [
      ...
      {
        id: "slide-2",
        image: "/image/kkn-hero-penjemputan.webp",
        badge: "Digitalisasi Penjemputan",
        title: "Penjemputan Sampah Terpilah Berbasis QR Code & Armada Berseka",
        location: "Wilayah Binaan KKN Tematik UNIKOM",
        metric: "500+ Setoran Terverifikasi",
        highlight: "Monitoring Real-Time Petugas & Timbangan",
        isPublished: true,
      },
      {
        id: "slide-3",
        image: "/image/kkn-hero-lokakarya.webp",
        badge: "Edukasi & Lokakarya",
        title: "Lokakarya Edukasi Pemilahan Sampah Mandiri - Bandung Bersih & Hijau",
        location: "Balai Warga, Wilayah Binaan UNIKOM 2026",
        metric: "92% Partisipasi Warga",
        highlight: "Pemberdayaan Masyarakat Menuju Zero Waste",
        isPublished: true,
      },
    ],
    marketProducts: [
