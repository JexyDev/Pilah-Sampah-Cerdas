...
async function main() {
  ...
  const configs = [
    ...
    { key: "attendance_min_duration_hours", value: "0", tipe: "number", deskripsi: "Durasi minimal presensi KKN (Jam) — 0 = gunakan durasi jadwal" },
    { key: "attendance_min_duration_minutes", value: "0", tipe: "number", deskripsi: "Durasi minimal presensi KKN (Menit tambahan)" },
    { key: "attendance_min_duration_seconds", value: "0", tipe: "number", deskripsi: "Durasi minimal presensi KKN (Detik tambahan)" },
    { key: "attendance_min_default_minutes", value: "30", tipe: "number", deskripsi: "Durasi minimum default presensi KKN jika jadwal tidak memiliki waktu (Menit)" },
