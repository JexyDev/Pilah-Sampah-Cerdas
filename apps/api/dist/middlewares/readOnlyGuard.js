            ...
            try {
                ...
                if (role === "CAMAT" || role === "LURAH" || role === "ADMIN_DLH") {
                    ...
                    if (writeMethods.includes(req.method)) {
                        ...
                        const isResolveDiscrepancy = role === "ADMIN_DLH" &&
                            req.method === "PUT" &&
                        ...
                        const isUserNotificationAction = req.originalUrl.includes("/notifications") ||
