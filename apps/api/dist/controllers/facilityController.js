...
export class FacilityController {
    ...
    async getFacilities(req, res) {
        try {
            ...
            const list = await facilityService.getFacilities(jenis);
    ...
    async recordProduction(req, res) {
        try {
            ...
            const log = await facilityService.recordProduction(id, Number(materialMasukKg), Number(outputKg), jenisOutput, periode, userId);
     ...
     */
    async distributeMaggot(req, res) {
        try {
