...
export class TransactionService {
    ...
    async createManualDeposit(petugasResiduId, diinputOleh, berat, fotoResiduUrl, lokasiGps, rwId) {
        return prisma.$transaction(async (tx) => {
            ...
            if (!finalRwId) {
                ...
                if (!area)
                    throw new Error("PETUGAS_RESIDU_NOT_ASSIGNED_TO_ANY_RW");
                finalRwId = area.id;
            }
