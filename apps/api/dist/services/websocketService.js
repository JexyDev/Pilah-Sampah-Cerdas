...
export const websocketService = {
     ...
     */
    broadcastDispatch: async (binId, qrCode, binLat, binLng) => {
        ...
        for (const petugas of allPetugas) {
            const distanceMeters = getDistanceMeters(binLat, binLng, Number(petugas.latitude), Number(petugas.longitude));
