...
export class CronService {
    ...
    async triggerScheduleNotifications(window) {
        try {
    ...
    async evaluateShiftPenalty(_shift) {
        try {
    ...
    async notifyHierarchy(role, areaId, qrCode) {
    ...
    async evaluateDailyWargaPenalty() {
        try {
    ...
    async checkWindowAbsence(window) {
        try {
