...
router.get("/audit-trail", roleMiddleware(["SUPER_USER"]), superUserController.getAuditTrail);
...
router.post("/cleansing/purge-duplicates", roleMiddleware(["SUPER_USER"]), superUserController.purgeDuplicates);
