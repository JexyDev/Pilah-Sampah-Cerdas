 ...
 */
router.post("/validate-qr-master", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.validateQrMaster);
/**
 * @swagger
 ...
 */
router.get("/dashboard", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.getDashboardStats);
/**
 * @swagger
 * /api/v1/kkn/handover:
 *   post:
 ...
 */
router.get("/warga-dampingan", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.getRegisteredWarga);
/**
 * @swagger
 * /api/v1/kkn/warga:
 *   get:
 ...
 */
router.post("/warga/activate-by-scan", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.activateByScan);
/**
 * @swagger
 ...
 */
router.post("/warga/activate-bin", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.activateBin);
/**
 * @swagger
 ...
 */
router.get("/warga/:wargaId", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.getWargaDetail);
/**
 * @swagger
 ...
 */
router.get("/activity-log", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.getActivityLog);
/**
 * @swagger
 ...
 */
router.post("/fasilitas/bantu-input", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.inputFacility);
/**
 * @swagger
 ...
 */
router.post("/location-ping", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknAttendanceController.updateLocation);
/**
 * @swagger
 * /api/v1/kkn/qr/claim:
 *   post:
 ...
 */
router.get("/kelompok/me", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.getMyGroup);
/**
 * @swagger
 ...
 */
router.post("/pemanfaatan-sampah", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.createPemanfaatanSampah);
/**
 * @swagger
 ...
 */
router.post("/register-warga", authMiddleware, roleMiddleware(["MAHASISWA_KKN"]), kknController.registerWarga);
