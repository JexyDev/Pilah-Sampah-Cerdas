...
const mapNotification = (n) => {
    ...
    else if (titleUpper.includes("TONG") ||
    ...
    else if (titleUpper.includes("PENGOSONGAN") ||
                ...
                formattedNotifications = [
                    {
                        id: "welcome-warga-01",
                        type: "INFO",
                        title: "Selamat Datang di Pilah Sampah Cerdas",
                        desc: "Akun Warga Anda aktif. Mari miliki kebiasaan memilah sampah sejak dari rumah.",
                        isRead: true,
                        time: "Baru saja",
                        icon: "info",
                        iconBg: "bg-green-100",
