 ...
 */
router.post("/", authMiddleware, roleMiddleware(["SUPER_USER", "ADMIN_DLH", "LURAH", "RW", "PETUGAS_RESIDU", "DPL"]), scheduleController.createSchedule);
/**
 * @swagger
 * /api/v1/schedules/{id}:
 *   delete:
 ...
 */
router.delete("/:id", authMiddleware, roleMiddleware(["SUPER_USER", "DPL"]), scheduleController.deleteSchedule);
/**
 * @swagger
 * /api/v1/schedules/{id}:
 *   put:
 ...
 */
router.put("/:id", authMiddleware, roleMiddleware(["SUPER_USER", "ADMIN_DLH", "LURAH", "RW", "PETUGAS_RESIDU", "DPL"]), scheduleController.updateSchedule);
