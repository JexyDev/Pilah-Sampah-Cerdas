...
void main() {
  group('Logic Deteksi Dual-Mode NIM vs Nomor HP Indonesia', () {
    test(
      '12 Digit No HP diawali 08 dikembalikan sebagai format ter-normalisasi',
      () {
    ...
    test(
      '11 Digit No HP tanpa 0 di depan (81234567890) ditambahkan 0 di depan',
      () {
    ...
    test(
      '10 Digit NIM Telkom/Unpad (1301210001) dikenali sebagai NIM valid',
      () {
    ...
    test(
      'Input kosong mengembalikan pesan error wajib diisi dalam Bahasa Indonesia',
      () {
        expect(
          validateIdentifier(''),
          equals('Nomor telepon atau NIM wajib diisi'),
        );
      },
    );

    test(
      'Input tidak valid (misal 5 digit) mengembalikan pesan format tidak valid',
      () {
        expect(
